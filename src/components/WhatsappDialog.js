...
export default function WhatsAppDialog() {
  const phoneNumber = "919990364233";
  ...
  return (
    ...
    >
      <div className="relative">
        ...
        <div className="relative flex h-12 w-12 xl:h-16 xl:w-16 items-center justify-center rounded-full bg-[#25D366] text-white shadow-2xl transition-all duration-300 group-hover:scale-110">
